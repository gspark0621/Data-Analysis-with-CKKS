...
#   1회면 0.99839 → 0.9999923 (2^-17). 2회면 CKKS 한계 (2^-32).
# ★ [Tier 1a / 2026-06] 1 → 2.
#   진단(hepta 라벨 압축 160~166)의 원인은 라벨 전파 누적 오차.
#   core_mask가 LP에서 mask로 수천 회 곱해지므로 2^-17(잔차 7.7e-6)도
#   누적 시 무시 불가. 2회(2^-32)로 올려 mask=1.0을 기계 정밀도까지 확보.
#   비용: +2 level (cleaning.py _ensure_level이 자동 _refresh). Core는 1회 호출이라 무시 가능.
_CLEANING_ITERS = 2
